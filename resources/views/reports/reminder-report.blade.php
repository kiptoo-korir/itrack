...
@section('css_scripts')
    <style>
        ...
        .bg-gradient {
            ...
            background-image: -webkit-linear-gradient(left, #ffffff, #e9ecef);
        }
...
@section('content')
    <div class="container">
        <div class="mx-auto text-center mb-4">
            ...
            <h4 class="pt-4">Detailed Report On Reminders</h4>
        </div>
        ...
        <div class="container" id="stats-list">
            <h5 class="text-center py-3"><b>Reminders Dispatched In Period</b></h5>
        </div>
        <div>
            @forelse ($activity as $reminder)
                <div class="reminder">
                    <h6 class="reminder-title">{{ $reminder->reminder_title }}</h6>
                    <p class="reminder-body">{{ $reminder->reminder_description }}</p>
                    <p class="reminder-body">Dispatched <b>{{ $reminder->created_at }}</b></p>
                </div>
            @empty
